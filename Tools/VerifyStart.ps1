...
foreach($block in @(
    ...
    @('gc','GC','gc/gc_9_1',@('CP_ME_CNTL','CP_MEC_CNTL','CP_INT_CNTL_RING0','GRBM_STATUS','GRBM_STATUS2','GRBM_GFX_INDEX','RLC_CNTL','RLC_SERDES_CU_MASTER_BUSY','RLC_SERDES_NONCU_MASTER_BUSY')),
    @('sdma','SDMA0','sdma0/sdma0_4_1',@('SDMA0_F32_CNTL','SDMA0_STATUS_REG','SDMA0_GFX_RB_CNTL','SDMA0_GFX_IB_CNTL')),
